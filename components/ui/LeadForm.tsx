...
export function LeadForm({
  ...
  const wrapperBase =
    surface === "card"
      ? "rounded-3xl border border-cream-50/10 bg-olive-900/70 backdrop-blur p-6 sm:p-8 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.9)]"
      : "";
  ...
  return (
    <div>
      ...
      <input
        ...
        className={cn(
          "w-full rounded-xl border border-cream-50/10 bg-olive-950/70 px-4 py-3.5 text-[15px] text-cream-50 placeholder:text-cream-100/30",
          "transition-colors focus:outline-none focus:border-gold-400 focus:ring-2 focus:ring-gold-400/30",
