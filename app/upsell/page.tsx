...
import { UPSELL_CHECKOUT_URL } from "@/lib/plans";

export const metadata: Metadata = {
  title: "95 de rețete sănătoase · Manuela Vlașin",
  description:
    "Adaugă în rutina ta 95 de rețete sănătoase, simple și nutritive. Preț special: 49 lei.",
};
        ...
        <div className="grid w-full gap-8 lg:grid-cols-[340px_1fr] lg:items-center lg:gap-12">
          <Reveal className="text-center lg:col-start-2 lg:row-start-1 lg:text-left">
            ...
            <p className="mx-auto mt-3 max-w-lg text-[14px] leading-[1.55] text-cream-100/80 sm:text-[16px] lg:mx-0">
              Adaugă în rutina ta 95 de rețete sănătoase, simple și nutritive,
              create pentru zilele în care vrei să mănânci bine fără să complici
              tot procesul.
            </p>
          </Reveal>
          ...
          >
            <figure className="flex h-full justify-center lg:justify-start">
              <Image
                ...
                alt="95 de rețete sănătoase — copertă"
                width={967}
                height={1500}
          ...
          <Reveal delay={0.2} className="lg:col-start-2 lg:row-start-5">
            <div className="flex flex-col items-center lg:items-start">
              <a href={UPSELL_CHECKOUT_URL} className="block w-full sm:w-auto">
